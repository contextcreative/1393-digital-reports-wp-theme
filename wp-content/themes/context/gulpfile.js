...
// Customizer SCSS Task
gulp.task('customizersass', function(){
    return gulp.src('assets/src/customizer-styles/**/*.scss')
        .pipe(sass())
        .pipe(cssnano())
        .pipe(browserSync.stream())
        .pipe(gulp.dest('assets/dist/css'));
...
gulp.task('watch', function(){
    ...
    gulp.watch('assets/src/customizer-styles/**/*.scss', gulp.series('customizersass'));
...
gulp.task('default', gulp.series('sass', 'iesass', 'customizersass', 'js', 'watch'));
